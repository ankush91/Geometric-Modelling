...
***---PLEASE NOTE - DEFAULT VALUE FOR RADIUS IS SET TO 0.1 AS IN HW1, 1.0 AS MENTIONED IN SPECIFICATION OF HW2 IS TOO BIG FOR FREECAD---****
...
-> Default File cpts_in.txt contain some default points as in example1 of the Hw specification.
[filename1.txt - filename5.txt] consist of all other examples (2-6) given in the specification of the Assignment.
